class PickScene extends Phaser.Scene {
  ...
  create() {
    ...
    var button2 = this.add.image(button1.x, 200 + button1.height + 60, 'roar', 0).setOrigin(0, 0).setScale(2).setInteractive();
    var button3 = this.add.image(button1.x, 200 + button1.height + button2.height + 120, 'numb', 0).setScale(2).setOrigin(0, 0).setInteractive();
